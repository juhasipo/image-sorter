...
func TestImageCategoryStore_CategorizeImage(t *testing.T) {
	...
	t.Run("Simple cases", func(t *testing.T) {
		...
		t.Run("One category", func(t *testing.T) {
			err := sut.CategorizeImage(images[0].Id(), categories[0].Id(), apitype.MOVE)
			a.Nil(err)
		...
		t.Run("Many categories", func(t *testing.T) {
			err := sut.CategorizeImage(images[0].Id(), categories[1].Id(), apitype.MOVE)
			a.Nil(err)
			err = sut.CategorizeImage(images[0].Id(), categories[2].Id(), apitype.MOVE)
			a.Nil(err)
		...
		t.Run("Many categories many images", func(t *testing.T) {
			err := sut.CategorizeImage(images[1].Id(), categories[1].Id(), apitype.MOVE)
			a.Nil(err)
			err = sut.CategorizeImage(images[2].Id(), categories[1].Id(), apitype.MOVE)
			a.Nil(err)
			err = sut.CategorizeImage(images[2].Id(), categories[2].Id(), apitype.MOVE)
			a.Nil(err)
	...
	t.Run("None category", func(t *testing.T) {
		...
		t.Run("First time", func(t *testing.T) {
			err = sut.CategorizeImage(images[0].Id(), categories[1].Id(), apitype.NONE)
			a.Nil(err)
...
func TestImageCategoryStore_RemoveImageCategories(t *testing.T) {
	...
	err = sut.CategorizeImage(images[1].Id(), categories[0].Id(), apitype.MOVE)
	a.Nil(err)
	err = sut.CategorizeImage(images[1].Id(), categories[1].Id(), apitype.MOVE)
	a.Nil(err)
...
func TestImageCategoryStore_RemoveImageRemovesCategories(t *testing.T) {
	...
	err = sut.CategorizeImage(images[1].Id(), categories[1].Id(), apitype.MOVE)
	a.Nil(err)
	err = sut.CategorizeImage(images[1].Id(), categories[2].Id(), apitype.MOVE)
	a.Nil(err)
	err = sut.CategorizeImage(images[2].Id(), categories[2].Id(), apitype.MOVE)
	a.Nil(err)
