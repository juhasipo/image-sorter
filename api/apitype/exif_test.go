...
func TestLoadExifData(t *testing.T) {
	...
	t.Run("Horizontal image", func(t *testing.T) {
		data, err := LoadExifData(NewHandleWithId(1, testAssetsDir, "horizontal.jpg", map[string]string{}))
		a.Nil(err)
	...
	t.Run("Vertical image", func(t *testing.T) {
		data, err := LoadExifData(NewHandleWithId(2, testAssetsDir, "vertical.jpg", map[string]string{}))
		a.Nil(err)
